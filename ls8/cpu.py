...
class CPU:
    ...
    def __init__(self):
        ...
        self.isr = 6 
        # Stack pointer starts at the top of a 0-7 index 
        self.sp = 7  
        # Flags set to false on initialization
        self.fl = 0b00000000  
        # Initialize stack pointer to RAM address f4
        self.reg[7] = 0xf4  
    ...
    # Map the ALU opcodes to commands
    ALU = {
        0b10100000: 'ADD',
        0b10101000: 'AND',
        0b10100111: 'CMP',
    ...
    # Ability to load a file as a second argument from the command line
    ...
    def run(self):
        ...
        while self.running:
            ...
            # Initialize intruction register and operations
            ...
            # Instruction doesn't modify program counter
    ...
    def check_inter(self):
        ...
        for interrupt in range(8):
            ...
            if interrupts & bit:
                ...
                # Push the registers to stack R0-R6
                for i in range(7):
                    self.reg[self.sp] -= 1
...
# Opcode: 01010010 'INT register'  issues the interrupt # stored in the register
    def INT(self):  
        self.reg[self.IS] != (1 << self.reg[self.operand_a])
        self.pc += 1
# Opcode: 00010011 'IRET' the return from an interrupt handler
    def IRET(self):  
        # pop R6-R0
